...
function readConstraint_(grid, a1, variables) {
  ...
  if (limitFormula !== null && variables) {
    const context = {
      grid: grid,
      variables: toSet_(variables),
      memo: {},
