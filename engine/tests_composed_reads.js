...
const RAW_SOURCE_ALLOWLIST = {
  ...
  'tests_f3c_home_sections.js': 'inspects index.html <main> raw to pin the F3c closing sections (capabilities, privacy, limits, add-on, help, FAQ, final CTA) and their separation from the F3a hero and F3b core sections; the <main> body is a region the shell composer never touches (only header/footer are composed); reads source on purpose and does not depend on the shell',
