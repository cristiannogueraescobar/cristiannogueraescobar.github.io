...
// 38. Solver EXAMPLES projection = 6125 bytes (the composed-solver byte total 215539
...
ok('39 i18n.js served as-is', fs.readFileSync(path.join(SITE, 'assets', 'i18n.js')).length === 274099);
