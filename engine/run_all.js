...
const suites = [
  ...
  'tests_safety', 'tests_strict', 'tests_sumif_criteria', 'tests_examples', 'tests_jsonld', 'tests_assets',
  'tests_i18n_pages', 'tests_direction', 'tests_structure', 'tests_worker_parity', 'tests_nav_menu', 'tests_solve_announce', 'tests_ex_drawer', 'tests_grid_a11y', 'tests_contrast', 'tests_error_i18n'
];
